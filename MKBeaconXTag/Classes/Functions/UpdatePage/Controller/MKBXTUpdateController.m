...
@interface MKBXTUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXTDFUModule *dfuModule;
...
@implementation MKBXTUpdateController

- (void)dealloc {
    NSLog(@"MKBXTUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxt_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKBXTCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxt_centralDeallocNotification" object:nil];
...
- (MKBXTDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBXTDFUModule alloc] init];
    }
    return _dfuModule;
}
