...
@interface MKBXTDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBXTCentralManager shared].peripheral];
}
