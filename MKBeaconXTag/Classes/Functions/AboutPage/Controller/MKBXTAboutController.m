...
@interface MKBXTAboutController ()
...
@implementation MKBXTAboutController

- (void)dealloc {
    NSLog(@"MKBXTAboutController销毁");
}
...
- (void)loadSubViews {
    ...
    UIImage *image = LOADICON(@"MKBeaconXTag", @"MKBXTScanController", @"bxt_aboutBottomIcon.png");
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKBeaconXTag", @"MKBXTScanController", @"bxt_about_logo.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKBeaconXTag", @"MKBXTScanController", @"bxt_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
