...
- (UILabel *)txPowerLabel {
    if (!_txPowerLabel) {
        ...
        _txPowerLabel.attributedText = [MKCustomUIAdopter attributedString:@[@"Tx power",@"   (-20,-16,-12,-8,-4,0,+3,+4，+6)"] fonts:@[MKFont(13.f),MKFont(12.f)] colors:@[DEFAULT_TEXT_COLOR,RGBCOLOR(223, 223, 223)]];
    }
